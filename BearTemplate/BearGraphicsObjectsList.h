...
RENDER_METHOD_REGISTRATION(bool, LoadAsText, const bchar* text,const bchar* entry_point, const BearMap<BearStringConteniar, BearStringConteniar>& defines, BearString& out_error, BearIncluder*includer)
...
RENDER_BEGIN_CLASS_REGISTRATION2(Texture2D, UnorderedAccess, bsize width, bsize height, bsize mips, bsize count, BearTexturePixelFormat pixel_format, BearTextureUsage type_usage = TU_STATIC, void* data = 0)
...
RENDER_BEGIN_CLASS_REGISTRATION2(TextureCube, ShaderResource, bsize width, bsize height, bsize mips, bsize count, BearTexturePixelFormat pixel_format, BearTextureUsage type_usage = TU_STATIC, void* data = 0)
RENDER_METHOD_REGISTRATION(void*, Lock, bsize mip = 0, bsize depth = 0)
RENDER_METHOD_REGISTRATION(void, Unlock)
RENDER_END_CLASS_REGISTRATION()
