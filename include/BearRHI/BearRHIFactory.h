...
#define RHI_FACTORY_DECLARE(Class,...) \
	virtual BearRHI##Class* create##Class(__VA_ARGS__)=0; \
	virtual void destroy##Class(BearRHI##Class *pObject)=0;
	class BearRHIFactory
	{
	public:
		...
		RHI_FACTORY_DECLARE(VertexInputLayout, const BearGraphics::BearVertexInputLayoutInitializer&initializer,void*data,bsize size);
